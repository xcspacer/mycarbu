                        ...
                        <div class="mt-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <x-text-input id="goa_quantity" class="block mt-1 w-full" type="number" step="0.001" min="0" name="goa_quantity" :value="old('goa_quantity', 0)" />
                                    <x-input-error :messages="$errors->get('goa_quantity')" class="mt-2" />
                                </div>

                                <div>
                                    <x-input-label for="sp95_quantity" :value="__('SP95 (m³)')" />
                                    <x-text-input id="sp95_quantity" class="block mt-1 w-full" type="number" step="0.001" min="0" name="sp95_quantity" :value="old('sp95_quantity', 0)" />
                                    <x-input-error :messages="$errors->get('sp95_quantity')" class="mt-2" />
                                </div>

                                <div>
                                    <x-input-label for="sp98_quantity" :value="__('SP98 (m³)')" />
                                    <x-text-input id="sp98_quantity" class="block mt-1 w-full" type="number" step="0.001" min="0" name="sp98_quantity" :value="old('sp98_quantity', 0)" />
                        ...
                        <div class="mt-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                                <div>
                                    ...
                                    <x-text-input id="goa_discount_per_liter" class="block mt-1 w-full" type="number" step="0.00001" name="goa_discount_per_liter" :value="old('goa_discount_per_liter', 0)" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="goa_plus_discount_per_liter" class="block mt-1 w-full" type="number" step="0.00001" name="goa_plus_discount_per_liter" :value="old('goa_plus_discount_per_liter', 0)" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="sp95_discount_per_liter" class="block mt-1 w-full" type="number" step="0.00001" name="sp95_discount_per_liter" :value="old('sp95_discount_per_liter', 0)" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="sp95_plus_discount_per_liter" class="block mt-1 w-full" type="number" step="0.00001" name="sp95_plus_discount_per_liter" :value="old('sp95_plus_discount_per_liter', 0)" />
                                ...
                                <div>
                                    ...
                                    <x-text-input id="sp98_discount_per_liter" class="block mt-1 w-full" type="number" step="0.00001" name="sp98_discount_per_liter" :value="old('sp98_discount_per_liter', 0)" />
